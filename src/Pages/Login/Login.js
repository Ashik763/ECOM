...
import RightSide from '../Register/RightSide/RightSide';
...
<div className="w-1/2 h-full flex align-items-center">
  ...
  <div className="  mt-20 p-10 m-auto ">
    <form onSubmit = {handleSubmit}>
      <div className="mb-3">
        <h2 className="text-center text-2xl font-bold"> Welcome back! </h2>
        <p className="text-[#838383] text-sm my-1 ">Enter your credentials to get access.  </p>
